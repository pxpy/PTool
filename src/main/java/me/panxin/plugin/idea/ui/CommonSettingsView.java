...
public class CommonSettingsView {
    ...
    public CommonSettingsView() {
        ...
        importButton.addActionListener(event -> {
            ...
            try {
                ...
                PToolConfig configuration = JSON.parseObject(json, PToolConfig.class);
                if (configuration == null) {
                    throw new IllegalArgumentException("json error, please make sure the file format is json.");
                }
                ServiceManager.getService(PToolConfigComponent.class).loadState(configuration);
                refresh();
            } catch (Exception e) {
        ...
        exportButton.addActionListener(event -> {
            ...
            try {
                File targetFile = new File(file.getPath() + "/PTool.json");
        ...
        starButton.addActionListener(event -> {
            try {
                ...
                LOGGER.error("open url failed:https://github.com/pxpy/PTool", e);
            }
        });
    ...
    private void createUIComponents() {
        config = ServiceManager.getService(PToolConfigComponent.class).getState();
        assert config != null;
        config.mergeProject();
