...
import me.panxin.plugin.idea.common.util.CollectionUtil;
import me.panxin.plugin.idea.common.util.StringUtil;
...
public class TranslatorService {
     ...
     * @param config 配置
     */
    public void init(PToolConfig config) {
    ...
    public String translateWithClass(String source, String className, Project project) {
        // 开关判断
        if (PToolConfig.ONLY_TRANSLATE.equals(config.getDocPriority())) {
